...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Sobre Nosotros</h1>
      <p>Bienvenido! Somos David y Omar, un grupo de estudiantes que decidieron crear esta pagina para crear y ofrecer el conocimiento mas actualizado a todos sus usuarios.
  ...
  <div class="w3-row">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Educacion</h1>
      <p>Actualmente cursamos el ultimo año de Secundaria en el Colegio Otto Krause.</b>
  </div>

  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Conocimientos</h1>
      <p>A lo largo de los años hemos trabajado con programacion estruturada, orientada a objetos, bases de datos con SQL y este año nos adentramos un poco en HTML, CSS y PHP.
      </p>
    </div>
  </div>
