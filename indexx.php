...
<div class="w3-top">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    ...
    <a href="login.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white w3-right">Login</a>
    <a href="signup.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white w3-right">Register</a>
  </div>
</div>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Bienvenido a Rabbits!&#128048;</h1>
      <p>Bienvenido Rabbit-Nauta! Aqui encontrarás la mejor información sobre la tecnologia mas actualizada de la galaxia
          Recuerda comportarte y siempre seguir aprendiendo!&#128524; <br>
  ...
  <div class="w3-row">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Informacion</h1>
      <p>En la barra lateral encontrarás los temas que tenemos disponibles para ti y tu conocimiento! solo elige el que mas te guste y adentrate en el! Recuerda que el conocimiento es el 
          arma mas poderosa que puedes tener. Si quieres saber sobre nosotros, creadores, redes sociales y más, no olvides ver la sección de <b>'Sobre Nosotros' y 'Contacto'</b>
  </div>

  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Donaciones</h1>
      <p>Si te interesa la pagina y quieres ser un miembro mas unido de la comunidad Rabbit considera darnos una pequeña donacion!
          Solo haz click en la seccion <b>Donaciones</b> y en tan solo simples pasos podrás ayudarnos a crecer aún más!
      </p>
    </div>
  </div>
