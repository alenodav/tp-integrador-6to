...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Backend</h1>
      <p>El Backend, también conocido como CMS o Backoffice, es la parte de la app que el usuario final no puede ver. Su función es acceder a la información que se solicita, a través de la app, para luego combinarla y devolverla al usuario final.<br>
  ...
  <div class="w3-row">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Software para Backend</h1>
      <p>NET. Uno de los lenguajes de programación más populares para el desarrollo de backend es C#, comúnmente llamado C-Sharp. Hace un excelente trabajo en la automatización de programación en servidores Windows y plataformas web (utilizando el marco ASP.Net).</b>
  </div>

  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Lenguajes para Backend</h1>
      <p>Otros lenguajes que se pueden usar para el desarrollo backend son: JavaScript,Python,Ruby,Java etc.
      </p>
    </div>
  </div>
